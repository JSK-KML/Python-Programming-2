...
2. Save the file as: `lab-test-1.py`
3. Upload the file to the Google Form at [here](https://forms.gle/WbPECkyRtqw8QuS79)
...
<iframe src="./lab-test-1.pdf" width="100%" height="400" allowfullscreen></iframe>

<br>

<a href="./lab-test-1.pdf" target="_blank" rel="noopener">
